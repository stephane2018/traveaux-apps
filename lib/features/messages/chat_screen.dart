...
/// Conversation avec un artisan : fil de messages + composer.
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return switch (m.type) {
                    MessageType.devis =>
                      _DevisMessage(message: m, maxWidth: bodyWidth * 0.85),
                    MessageType.photo =>
                      _PhotoMessage(message: m, width: bodyWidth * 0.58),
                    MessageType.text =>
                      _TextBubble(message: m, maxWidth: bodyWidth * 0.78),
                  };
                },
              ),
            ),
            _Composer(conversationId: conversationId),
          ],
        ),
      ),
    );
...
/// En-tête : retour, avatar, nom + statut « En ligne », appel.
class _ChatHeader extends StatelessWidget {
  const _ChatHeader({required this.artisan});
      ...
      child: Row(
        ...
        children: [
          TaSquareButton(
            ...
            onTap: () => context.pop(),
            child:
                TaIcon(TaIcons.arrowLeft, size: 16, mono: true, color: t.text),
          ),
          TaAvatar(artisan: artisan, size: 40, showMetier: false),
          Expanded(
            child: Column(
...
/// Message « devis proposé » : montant, délai et actions.
        ...
        child: TaCard(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${message.delai} · main d’œuvre + pièces incluses',
                style: context.taSub,
              ),
...
/// Message photo (placeholder stylisé).
...
/// Bulle de texte : verte à droite (moi), surface à gauche (artisan).
        ...
        children: [
          ...
          AnimatedOpacity(
            ...
            child: TaSquareButton(
              ...
              onTap: _send,
              child: TaIcon(TaIcons.send,
                  size: 18, mono: true, color: t.primaryInk),
            ),
          ),
        ],
      ),
